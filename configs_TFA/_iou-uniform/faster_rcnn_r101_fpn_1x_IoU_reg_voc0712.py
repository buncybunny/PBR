...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            ...
            roi_layer=dict(type='RoIAlign', out_size=7, sampling_ratio=2),
            out_channels=256, freeze=False,
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'TEST/VOC2007/ImageSets/Main/test.txt',
        img_prefix=data_root + 'TEST/VOC2007/',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r101_fpn_1x_IoU_reg_voc0712'
load_from = None
resume_from = None
workflow = [('train', 1)]
